...
export const suburbs: Suburb[] = [
    {
        ...
        local: [
            'Golden Grove is the biggest suburb we cover, and it\'s one we work in most weeks. It was master-planned from the mid-1980s and built out through the 1990s and 2000s, so the housing runs from early brick-veneer courtyard homes near Golden Grove Village through to the larger two-storey builds that went up later.',
            'That matters more than it sounds. A Golden Grove home built in 1988 has a switchboard that\'s now close to forty years old, most likely with a single RCD covering the power points and nothing protecting the lighting circuits. A home built in 2005 down the road usually has RCBOs and a board that\'s fine, but no spare space in it for an EV charger circuit. Two different jobs, two streets apart.',
            'Being local means we aren\'t padding the quote with travel time from the other side of town. If you need someone out for a dead circuit or a tripping safety switch, we\'re coming from Wynn Vale, not Adelaide CBD.',
        ],
        ...
        localJobs: [
            ...
            },
            {
                ...
                body: 'Golden Grove has the garage space and the driveways for home charging, and we install a lot of wall chargers here. The job is rarely just the charger. It\'s usually a dedicated circuit, board space, correct RCD protection with DC fault detection, and notifying SA Power Networks where that\'s required.',
            },
            {
                title: 'Halogen downlight replacements',
                body: 'A lot of the late-1990s and early-2000s homes still run 50W halogen downlights. They\'re hot, they eat power, and the older ones needed clearance from insulation for a reason. Swapping a house over to LED is a straightforward day of work and the difference on the power bill is immediate.',
            },
            {
        ...
        faqs: [
            {
                ...
                answer: 'We\'re based in Wynn Vale, which is a few minutes down Golden Grove Road. For urgent work we can usually be there the same day, and routine jobs like switchboard upgrades or downlight replacements are normally booked within the week.',
            },
            {
                question: 'My Golden Grove home is from the late 1980s. Does the switchboard need upgrading?',
                answer: 'Probably, yes. Boards from that era typically have rewireable fuses or early circuit breakers with, at most, one safety switch covering the power points. Lighting circuits were usually left unprotected. If yours has never been touched, it\'s worth a look, and we\'ll tell you straight if it can wait.',
            },
            {
                question: 'Can you install an EV charger in Golden Grove?',
                answer: 'Yes. We install wall-mounted home chargers on a dedicated circuit with the correct RCD protection. The main things we check first are whether there\'s spare space and capacity in your switchboard and how far the run is from the board to the garage, because that drives the cable size and the price.',
            },
            {
                question: 'Do you do emergency electrical work in Golden Grove?',
                answer: 'Yes. Loss of power, a breaker that won\'t reset, burning smells, sparking outlets or water in a switchboard are all things we\'ll prioritise. Call us on 0435 006 420 and we\'ll tell you honestly whether it needs someone now or whether it can safely wait until morning.',
            },
            {
                question: 'Can you replace my halogen downlights with LEDs?',
                answer: 'Yes, and it\'s one of the more worthwhile upgrades on an older Golden Grove home. We replace the fittings, not just the globes, so you get proper LED fittings that are safe to be covered by insulation and won\'t cook the ceiling space.',
            },
            {
                question: 'Do you install ovens and cooktops in Golden Grove?',
                answer: 'Yes. We connect ovens, cooktops and rangehoods, including hardwired installs. If you\'re moving from gas to induction, tell us early, because induction cooktops usually need a dedicated circuit run from the switchboard rather than the existing oven point.',
            },
        ],
    },
    {
        ...
        local: [
            ...
            'The work here looks different to the older suburbs down the hill. We\'re rarely pulling out ceramic fuses in Greenwith. What we get instead is a twenty-five-year-old board that\'s technically fine but completely full, and a homeowner who wants an EV charger, a pool pump, ducted air conditioning and a heated alfresco all running off it. That\'s a load calculation and often a board rebuild, not a quick add-on.',
            'The other big one here\'s lighting. A lot of Greenwith homes were built with halogen downlights everywhere, and the owners are now replacing them with LED, adding feature lighting to the stairwell or the void, and running LED strip through the kitchen and the alfresco.',
        ],
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'It depends entirely on the run length, whether it\'s going into existing joinery or a new build, and how the driver and switching are handled. A single under-bench run in an existing kitchen is a small job. Coving through a whole living area with dimming isn\'t. We quote it properly after a look.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Yes, including upstairs where there\'s no accessible roof space above. That\'s a harder job than a single-storey ceiling and it needs planning around joists and existing wiring, but it\'s very doable. We\'ll tell you upfront if a particular spot isn\'t practical.',
            },
            {
                question: 'Do you cover Greenwith for emergency callouts?',
                answer: 'Yes. We\'re ten minutes away in Wynn Vale. Call 0435 006 420 and describe what\'s happening. If it\'s a genuine hazard, sparking, burning smells or water in the board, turn the main switch off first and then call.',
            },
        ],
    },
    {
        ...
        intro:
            'JPD Complete Electrical services Hope Valley for switchboard upgrades, safety switch installs, downlights, oven and cooktop connections, fault finding and emergency callouts. We\'re based nearby in Wynn Vale and we work across the Tea Tree Gully council area most days.',
        local: [
            'Hope Valley went up largely through the 1960s and 70s, around the reservoir and either side of Grand Junction Road. It\'s a well-built older suburb, and the electrical work here reflects that.',
        ...
        localJobs: [
            ...
            },
            {
                ...
                body: 'Plenty of homes in this suburb have never had an RCD fitted. If yours has a row of ceramic fuses and nothing else, you have no protection against electric shock at all. That\'s the gap we close first.',
            },
            {
                title: 'Fault finding on old circuits',
                body: 'Older wiring gives you intermittent faults, lights that flicker, a circuit that trips only when it rains, a powerpoint that works some days. That takes methodical testing rather than guesswork, and it\'s work we do properly rather than replacing parts until it stops.',
            },
            {
                title: 'Rental compliance for landlords',
                body: 'Hope Valley has a solid share of rental stock, and a lot of it\'s old enough that the safety switch and smoke alarm arrangements need checking. We test, report and fix, and you get documentation you can actually put on file.',
            },
        ],
        landmarks: [
        ...
        faqs: [
            {
                ...
                answer: 'It isn\'t automatically dangerous, but it means you almost certainly have no safety switch protection, and a rewireable fuse doesn\'t protect a person from a shock. It also means the board is old enough that the wiring behind it deserves a look. It\'s the first thing we would recommend addressing in a house of that era.',
            },
            {
                question: 'How much does a switchboard upgrade cost in Hope Valley?',
                answer: 'It depends on the number of circuits, whether the existing enclosure can be reused, the condition of the incoming supply, and what we find behind the board once it\'s off. We give you a fixed price after looking at it, and if we think something might turn up once we open it, we tell you before we start rather than after.',
            },
            {
                question: 'Does my whole 1970s house need rewiring?',
                answer: 'Usually not. Most of the time a switchboard upgrade plus a few repairs is enough. Full rewires are the exception, not the rule, and we\'ll only suggest one if the testing actually supports it. If someone quotes a full rewire without testing first, get a second opinion.',
            },
            {
                question: 'Do you install safety switches in older Hope Valley homes?',
                answer: 'Yes, and it\'s normally done as part of a switchboard upgrade rather than as a bolt-on. Fitting RCBOs across the board gives you shock protection on every circuit and overload protection at the same time, which is a better outcome than adding one RCD to an old fuse board.',
            },
            {
                question: 'Can you do smoke alarms at the same time?',
                answer: 'Yes. If we\'re already in the roof space for a board upgrade it\'s the sensible time to sort out interconnected mains-powered alarms. We\'ll check what you currently have and what your obligations are, and give you a straight answer rather than an upsell.',
            },
            {
                question: 'Do you do emergency work in Hope Valley?',
                answer: 'Yes. Call 0435 006 420. Total loss of power, a breaker that won\'t reset, burning smells from the board or a sparking outlet all get prioritised. We\'re a few minutes away in Wynn Vale.',
            },
        ],
    },
    {
        ...
        population: 7865,
        council: 'City of Tea Tree Gully',
        hook: 'This Is Where We\'re Based',
        ...
        local: [
            'Wynn Vale is home. Justin lives and works out of here, which means when you call for a Wynn Vale job, you aren\'t waiting on someone to fight their way across town.',
            ...
            'That\'s the bread and butter here. Board upgrades, adding proper RCD protection, replacing tired halogen downlights with LED, adding powerpoints where 1988 thought two would be plenty, and putting in EV chargers for people who have just bought their first electric car.',
        ],
        ...
        localJobs: [
            {
                ...
                body: 'The original Wynn Vale boards are at the end of their sensible life. Early MCBs or fuses, one RCD if you\'re lucky, and no spare ways. We replace them with a correctly sized board on RCBOs so each circuit is protected and labelled on its own.',
            },
            {
        ...
        faqs: [
            {
                ...
                answer: 'Yes. JPD Complete Electrical is owner-operated by Justin, who lives in Wynn Vale. It isn\'t a call centre with a local phone number. If you\'re in Wynn Vale, you\'re getting an electrician from your own suburb.',
            },
            {
                question: 'How fast can you get to a Wynn Vale job?',
                answer: 'For genuine emergencies in Wynn Vale, usually within the hour if we aren\'t already on the tools somewhere. For routine work we\'re normally booking within the week. Call 0435 006 420 and we\'ll give you a real answer rather than a maybe.',
            },
            {
                question: 'My Wynn Vale house is from about 1990. What needs looking at?',
                answer: 'The switchboard, first. Boards of that vintage usually have one RCD covering power points and nothing on the lighting circuits, and they\'re now old enough that the components are past their service life. After that, halogen downlights if you have them, and the smoke alarms if they have never been replaced.',
            },
            {
                question: 'Can you install an EV charger in Wynn Vale?',
                answer: 'Yes. We install home wall chargers on a dedicated circuit with the correct RCD protection and notify SA Power Networks where that\'s required. The two things that drive the price are the distance from the switchboard to the garage and whether the board has room for the circuit.',
            },
            {
                question: 'Do you do small jobs, or only big ones?',
                answer: 'Small jobs are fine. A single powerpoint, a dead light, a fan that needs replacing. Being based in the suburb means a small Wynn Vale job isn\'t a waste of half a day in the van, so we\'re happy to take them on.',
            },
            {
                question: 'Do you install ovens, cooktops and rangehoods?',
                answer: 'Yes. Including hardwired ovens and induction cooktops. Induction usually needs its own circuit run from the board rather than plugging into the existing oven point, so it\'s worth telling us what you have bought before delivery day.',
            },
        ],
    },
    {
        ...
        local: [
            'Highbury sits where the suburbs meet the foothills, backing onto the River Torrens Linear Park and the old aqueduct reserve. It\'s a mixed suburb electrically, and that keeps the work interesting.',
            ...
            'Sloping blocks are a factor here too. Split-level homes, undercroft garages and detached sheds all mean submains, and a submain that was run in 1974 to feed a shed light isn\'t going to carry a workshop. We check what\'s actually in the ground before anyone commits to a plan.',
        ],
        ...
        localJobs: [
            ...
            },
            {
                ...
                body: 'Sloping blocks in Highbury mean detached sheds, undercroft garages and workshops. If yours is fed by an undersized cable run decades ago, you\'ll see lights dim when the compressor starts. We size and run a proper submain with its own distribution board and protection.',
            },
            {
        ...
        faqs: [
            {
                ...
                answer: 'Yes, right up to the Linear Park and the aqueduct reserve. We\'re based in Wynn Vale, so Highbury is a short run down Hancock Road for us.',
            },
            {
                question: 'My Highbury shed has no power, or the power is unreliable. Can you fix it?',
                answer: 'Yes, and it\'s a job we see a lot here. Usually the existing submain is too small, has degraded, or was never protected properly. We test what\'s there, then either repair it or run a correctly sized new submain with its own board and RCD protection in the shed.',
            },
            {
                question: 'How do I know if my Highbury switchboard needs upgrading?',
                answer: 'Rewireable ceramic fuses, no safety switches, a board that trips regularly, scorch marks, or a board so full there\'s nowhere to add a circuit are all clear signs. If you aren\'t sure, send us a photo of the open board and we\'ll tell you honestly whether it\'s urgent.',
            },
            {
                question: 'Can you install downlights in a raked or cathedral ceiling?',
                answer: 'Usually yes, but it needs a look first. Raked ceilings often have limited or no accessible space above, so the fitting depth and the cable route matter. We\'ll tell you upfront if a spot isn\'t practical rather than promising it and then finding out.',
            },
            {
                question: 'Do you do emergency callouts in Highbury?',
                answer: 'Yes. Call 0435 006 420. If there\'s sparking, a burning smell or water in the switchboard, turn the main switch off first and then call us.',
            },
            {
    ...
    },
    {
        ...
        local: [
            ...
            'That gives us two very different jobs in the same suburb. On the residential side it\'s old switchboards, rental compliance and the usual repairs on ageing wiring. On the commercial side it\'s shop and office fitouts, lighting upgrades, distribution boards, exit and emergency lighting, and test and tag for businesses that need the paperwork to be right.',
            'Modbury also has more units, townhouses and infill development than the suburbs around it. Unit switchboards, shared supplies and metering arrangements come with their own quirks, and they\'re worth getting right the first time.',
        ],
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'Yes, and we do a lot of it. Safety switch testing, smoke alarm compliance, repairs off condition reports, and clear documentation afterwards. We turn up when we say we\'ll, which is usually the thing property managers actually care about.',
            },
            {
                question: 'Do you do test and tag in Modbury?',
                answer: 'Yes. We test and tag portable appliances on whatever schedule your workplace requires and provide a register. It\'s a service we run across Adelaide\'s north-east regularly, so we can usually fit a site in without a long wait.',
            },
            {
                question: 'My Modbury unit\'s power keeps tripping. What\'s going on?',
                answer: 'Usually one of three things. A faulty appliance leaking to earth, an overloaded circuit, or a genuine wiring fault. In units it\'s also sometimes a shared or wrongly labelled circuit. It needs proper testing to isolate rather than guesswork, and that\'s what we do.',
            },
            {
                question: 'Do you offer emergency electrical work in Modbury?',
                answer: 'Yes. Call 0435 006 420. Loss of power, a breaker that won\'t reset, sparking, burning smells or water in the switchboard all get prioritised, for homes and for businesses.',
            },
            {
                question: 'Can you upgrade the lighting in my Modbury shop to LED?',
                answer: 'Yes, and it usually pays for itself faster than people expect in a retail or office space that runs lights ten hours a day. We can also handle it after hours so we aren\'t working around your customers.',
            },
        ],
    },
    {
        ...
        localJobs: [
            ...
            },
            {
                ...
                body: 'Redwood Park houses get hot. We install ceiling fans, including on existing light points, wire in split system power circuits, and add the wall controls so it isn\'t all on a remote that goes missing.',
            },
        ],
        landmarks: [
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'An older installation that predates the requirement is generally allowed to remain as it was installed, so it isn\'t automatically illegal. But it does mean you have no shock protection, and any significant work on the board will trigger the requirement to bring it up to current standards anyway. It\'s worth doing on its own merits.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Yes. We can install onto an existing light point or run a new point where you want it, and fit a wall control rather than leaving you dependent on a remote. If the ceiling needs bracing for the fan, we\'ll tell you.',
            },
            {
                question: 'Do you do emergency electrical callouts in Redwood Park?',
                answer: 'Yes. We\'re only a few minutes away in Wynn Vale. Call 0435 006 420 for loss of power, breakers that won\'t reset, sparking or burning smells.',
            },
            {
                question: 'Can you install an oven or cooktop I have bought myself?',
                answer: 'Yes, as long as it meets Australian safety standards. We\'ll connect a customer-supplied appliance without any fuss. If you\'re switching to induction, mention it when you book, because it usually needs its own circuit.',
            },
        ],
    },
    {
        ...
        local: [
            'Ridgehaven is two things at once. Most of it\'s 1960s and 70s residential, modest homes on sensible blocks with a decent share of rental property. The other part is the light industrial area off Milne Road and Bridge Road, which is full of workshops, trades and small manufacturing.',
            ...
            'On the industrial side it\'s a different set of tools. Three-phase supplies, distribution boards, machine circuits, workshop lighting, exit and emergency lighting, and test and tag. We do that work too, and being ten minutes away in Wynn Vale means we can get to a breakdown before it costs you a full day of production.',
        ],
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'Rewireable ceramic fuses, no safety switches, regular tripping, scorching or heat marks, a burning smell, or a board with no spare space are all reasons to have it looked at. Send us a photo of the open board and we\'ll give you an honest read on how urgent it is.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Yes, for homes and businesses. Call 0435 006 420. We prioritise loss of power, breakers that won\'t reset, sparking, burning smells and anything that has water in it.',
            },
            {
                question: 'Do you install safety switches on their own, without a full board upgrade?',
                answer: 'Sometimes it\'s possible, but on an old fuse board it\'s often not the better option. Fitting RCBOs as part of a board upgrade gives you protection on every circuit rather than one shared safety switch that takes out half the house whenever anything trips. We\'ll explain both options and what each actually costs.',
            },
        ],
    },
    {
        ...
        local: [
            'St Agnes went up mainly through the 1970s, around The Village shopping centre and either side of Kelly Road. It\'s a quiet, established suburb where a lot of the original owners are still in the same houses.',
        ...
        localJobs: [
            ...
            },
            {
                ...
                body: 'Usually it\'s either an overloaded original circuit, a faulty appliance leaking to earth, or moisture somewhere it shouldn\'t be. We test to find which, rather than replacing parts and hoping. Once we know, the fix is usually simple.',
            },
            {
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'If the board still has rewireable fuses or no safety switches, yes. It\'s the single biggest safety improvement available on a house of that era, and it also gives you the capacity to add air conditioning, a charger or a renovated kitchen later without redoing everything.',
            },
            {
                question: 'Can you get power to my shed or undercroft garage?',
                answer: 'Yes. We work out what\'s already there, size a submain for what you actually intend to run, and install it with its own board and protection at the shed end. That stops the dimming lights and the tripping you get from an undersized old run.',
            },
            {
            ...
            },
            {
                ...
                answer: 'We\'re based in Wynn Vale, a few minutes away. Urgent work is usually same-day and routine bookings are normally within the week. Call 0435 006 420.',
            },
            {
    ...
    },
    {
        ...
        local: [
            'Fairview Park sits up against the foothills at the top of Golden Grove Road, backing onto reserve land. It went up through the 1970s and into the 80s, and a lot of it\'s built into the slope.',
            ...
            'The housing stock itself is at the age where boards are due. Original fuse boards or early breakers, usually no safety switch on the lighting, and not much spare space. It\'s also a suburb where people stay a long time and renovate rather than move, so we do a good amount of kitchen, bathroom and extension work alongside the straight upgrades.',
        ],
        ...
        localJobs: [
            ...
            },
            {
                ...
                body: 'Terraced gardens, retaining walls and steep driveways in Fairview Park need lighting that\'s both safe and durable. We install step lights, garden and path lighting, and weatherproof outdoor power with proper IP-rated fittings, not indoor gear used outside.',
            },
            {
        ...
        faqs: [
            {
                ...
                answer: 'Yes, and it\'s worth doing properly here. Steps, driveways and retaining walls are where people actually trip. We use IP-rated fittings and outdoor-suitable cable so it survives a foothills winter instead of failing in the first wet month.',
            },
            {
                question: 'My Fairview Park switchboard is in an awkward spot. Can it be moved?',
                answer: 'Often yes. Relocating a board is more work than replacing it in place, because the incoming supply and every circuit has to be extended or rerouted, but it\'s very doable and sometimes the right call. We\'ll price both options so you can decide.',
            },
            {
                question: 'Do you do renovation electrical work in Fairview Park?',
                answer: 'Yes. Kitchens, bathrooms, extensions and outdoor areas. We do the rough-in before the plaster and the fit-off after the fixtures, and we coordinate with your builder so we aren\'t the trade holding up the job.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Yes. Call 0435 006 420. We\'re based in Wynn Vale, which is a short run down Golden Grove Road.',
            },
            {
    ...
    },
    {
        ...
        local: [
            ...
            'The original housing here\'s old enough that the electrical work is fairly predictable. Rewireable fuse boards, no safety switches, unearthed lighting circuits, and far fewer circuits than a modern household needs. Those are the jobs we do most in this suburb, and they\'re usually clean and straightforward.',
            'The infill is a different story. New builds on subdivided blocks need supply arrangements sorted, and the older house next door sometimes gets disturbed in the process. If you have had building work next door and something has changed with your power, that\'s worth a look.',
        ],
        ...
        localJobs: [
            ...
            },
            {
                ...
                body: 'Safety switch testing, smoke alarm compliance, and repairs off condition reports for landlords and property managers, with documentation for the file and turnaround that doesn\'t hold up a tenancy.',
            },
            {
        ...
        faqs: [
            {
                ...
                answer: 'The switchboard. If it still has ceramic fuses you have no safety switch protection at all, and that\'s the single biggest gap. Once the board is sorted, the rest of the house can be assessed and dealt with in priority order rather than all at once.',
            },
            {
                question: 'Do you work with landlords and property managers in Holden Hill?',
                answer: 'Yes. Safety switch testing with reports, smoke alarm compliance, and repairs off condition reports. We show up when we say we\'ll and we give you paperwork you can actually file.',
            },
            {
                question: 'The lights flicker in one part of my house. Is that serious?',
                answer: 'It can be. Flickering usually points to a loose connection somewhere, and a loose connection generates heat. In older wiring that\'s worth checking sooner rather than later. It isn\'t always urgent, but it shouldn\'t be ignored.',
            },
            {
                question: 'Can you add a circuit for a new appliance?',
                answer: 'Yes. Dishwashers, induction cooktops, air conditioning and EV chargers generally want their own circuit rather than sharing an existing one. If the board is full, that becomes a conversation about upgrading it, and we\'ll be upfront about that before starting.',
            },
            {
                question: 'Do you do emergency work in Holden Hill?',
                answer: 'Yes. Call 0435 006 420 for loss of power, breakers that won\'t reset, sparking, burning smells or water in the switchboard. Turn the main switch off first if there\'s anything visibly wrong.',
            },
            {
    ...
    },
    {
        ...
        local: [
            ...
            'Electrically, this is a suburb of boards that are now around thirty years old. Not ancient, but at the point where components have aged, where there\'s often a single RCD covering power circuits only, and where there\'s rarely spare space for anything new.',
        ...
        faqs: [
            {
                question: 'Do you service Gulfview Heights even though it\'s partly in the Salisbury council area?',
                answer: 'Yes. Council boundaries don\'t affect who can do your electrical work. We\'re based in Wynn Vale, which is a few minutes away, so the whole suburb is well within our normal patch.',
            },
            {
            ...
            {
                question: 'What\'s involved in replacing halogen downlights with LED?',
                answer: 'We replace the complete fitting rather than putting an LED globe into an old halogen can. That gives you a fitting rated to be covered by insulation, removes the heat, and typically cuts each light from around 50 watts to under 10. On a house with thirty downlights that\'s a real difference.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Yes. Call 0435 006 420. We prioritise loss of power, breakers that won\'t reset, sparking, burning smells and anything involving water in the switchboard.',
            },
            {
                question: 'Do you provide a Certificate of Compliance?',
                answer: 'Yes, on every job where one is required. It\'s your record that the work was done by a licensed electrician and tested. Keep it, because it matters when you sell or when an insurer asks.',
            },
        ],
    },
    {
        ...
        local: [
            'Tea Tree Gully is the original village that gave the whole council area its name, and it\'s easily the most varied suburb we work in. Stone cottages from the 1850s through to the turn of the century sit alongside 1970s and 80s brick veneer and larger semi-rural blocks running up towards Anstey Hill.',
            'The old stone places take a different approach. Solid walls with no cavity mean there\'s nowhere to hide a cable, so it\'s surface conduit run neatly, or channelling, or coming down from above. Ceilings are often lath and plaster and won\'t forgive a rough job. Getting an outlet into the right place in a 140-year-old cottage takes planning, not brute force.',
            'The bigger blocks bring their own work. Sheds, workshops, water pumps, gates and outbuildings all need submains, and a lot of what\'s out there was run decades ago and is undersized for what it is now being asked to do.',
        ],
        ...
        localJobs: [
            {
                ...
                body: 'Solid stone walls, lath and plaster ceilings, and no cavity to run through. We do this carefully, with surface conduit run properly where that\'s the sensible answer, and we discuss the approach with you before drilling anything.',
            },
            {
                title: 'Switchboard upgrades on very old installations',
                body: 'Some of the older Tea Tree Gully properties still have installations that predate almost everything. We replace the board, test what\'s behind it, and give you an honest picture of the wiring rather than quietly moving on.',
            },
            {
            ...
            },
            {
                ...
                body: 'Plenty of the older properties here have never had an RCD fitted. On a rural-feel block with sheds and outdoor power, that gap matters more than it does in a standard suburban home. It\'s the first thing we fix.',
            },
        ],
        landmarks: [
        ...
        faqs: [
            {
                ...
                answer: 'Yes, but it takes planning and it won\'t always be invisible. Solid stone has no cavity, so the honest options are neat surface conduit, careful channelling, or coming down from the ceiling space. We\'ll show you the options and what each looks like before we start rather than deciding for you.',
            },
            {
                question: 'My Tea Tree Gully property has a shed with unreliable power. Can you fix it?',
                answer: 'Yes, and it\'s one of the most common jobs out here. Usually the existing submain is undersized or has degraded over the years. We test it, work out what you actually want to run in the shed, and install a properly sized submain with its own board and protection.',
            },
            {
                question: 'Do older Tea Tree Gully homes need a full rewire?',
                answer: 'Sometimes, but far less often than people expect. Most of the time the board is the urgent part and the wiring can be tested and dealt with in stages. We won\'t recommend a full rewire unless the testing actually supports it.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Yes, and it\'s usually done as part of a board upgrade. On a property with outdoor power, sheds and pumps, RCD protection is more important than on a standard suburban house, not less.',
            },
            {
                question: 'How quickly can you get to Tea Tree Gully?',
                answer: 'We\'re based in Wynn Vale, a short run away. Urgent work is usually same-day, and routine bookings are normally within the week. Call 0435 006 420.',
            },
        ],
    },
    {
        ...
        local: [
            'Banksia Park is a quiet 1970s suburb tucked between Anstey Hill and Milne Road, built on generous blocks with plenty of established trees. It\'s the sort of suburb where houses don\'t turn over often.',
        ...
        faqs: [
            {
                ...
                answer: 'Yes, in almost every case. A board of that age has no safety switch protection, uses fuses or early breakers past their service life, and has no capacity for anything you might want to add. It\'s the highest-value electrical work available on a house of that vintage.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Yes. Call 0435 006 420. Loss of power, breakers that won\'t reset, sparking or burning smells all get prioritised. We\'re a short drive away in Wynn Vale.',
            },
            {
                question: 'Can you replace fluorescent battens with LED?',
                answer: 'Yes, and it\'s worth doing. Old fluorescent battens in kitchens and laundries are dim, they flicker as they age, and the ballasts fail. Modern LED battens or a proper LED downlight layout is a straightforward swap with an immediate difference.',
            },
        ],
    },
    {
        ...
        local: [
            ...
            'Being small doesn\'t mean being ignored. A lot of trades won\'t make the trip for a single job in Vista. We\'re ten minutes away in Wynn Vale, so a one-hour job here isn\'t a problem for us.',
        ...
        localJobs: [
            {
                title: 'Switchboard upgrades',
                body: 'Original boards on 1970s and 80s Vista homes need replacing. We fit a correctly sized board on RCBOs so every circuit gets its own protection, and label it so the next person knows what\'s what.',
            },
            {
        ...
        faqs: [
            {
                ...
                answer: 'Yes. We\'re based in Wynn Vale, about ten minutes away, so a single powerpoint or a dead light in Vista isn\'t a wasted trip. Plenty of trades won\'t bother with a small suburb. We\'ll.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Very likely. Boards from that era typically have one safety switch at best, covering power circuits only, and they\'re now around forty years old. We\'ll look at it and tell you honestly whether it\'s urgent or whether it can wait.',
            },
            {
                question: 'Do you do emergency callouts in Vista?',
                answer: 'Yes. Call 0435 006 420. If there\'s sparking, a burning smell or water in the board, switch the main off first and then call us.',
            },
            {
