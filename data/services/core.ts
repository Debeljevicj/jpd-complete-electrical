...
export const coreServices: Service[] = [
    {
        ...
        icon: 'emergency',
        blurb: 'Lost power, tripping breakers, burning smells or sparking outlets. Call and we\'ll tell you straight whether it can wait.',
        ...
        intro:
            'Power out, a breaker that won\'t stay on, a burning smell at the switchboard or a sparking outlet. Call 0435 006 420. We\'re based in Wynn Vale and we cover the Tea Tree Gully area, so you aren\'t waiting on someone crossing town.',
        sections: [
            {
                heading: 'What Counts as an Electrical Emergency',
                body: [
                    'Not everything that goes wrong needs someone out that hour, and we would rather tell you that on the phone than charge you for a callout you didn\'t need. These are the ones that genuinely shouldn\'t wait:',
                ],
                bullets: [
                    ...
                    'Anything hot to touch that shouldn\'t be, including a switchboard door or a wall around an outlet',
                ],
            },
            {
                ...
                body: [
                    ...
                    'Don\'t keep resetting a breaker that trips straight back on. It\'s tripping because it\'s detecting something, and forcing it repeatedly is how a fault becomes a fire. Leave it off and call.',
                    ...
                    'If the problem is a tap or metal fixture giving you a tingle, keep everyone away from it, turn the main switch off, and call. That symptom can indicate a lost neutral or a fault energising the plumbing, and it\'s one of the more genuinely dangerous things we get called to.',
                ],
            },
            {
                ...
                body: [
                    ...
                    'Once we know what it is, you get a clear explanation and a price before we do the repair. If it\'s something we can fix on the spot you\'ll usually have power back the same visit. If it needs parts or a bigger job like a switchboard replacement, we make it safe, restore what we safely can, and book the rest properly.',
                ],
            },
            {
                heading: 'If the Whole Street Is Out',
                body: [
                    'If your neighbours have lost power too, that\'s a network fault, not your installation, and it belongs to SA Power Networks rather than us. Their faults and emergencies line is 13 13 66. Calling us in that situation just costs you a callout for something we can\'t fix.',
                    'The quick test is your neighbours and your own main switch. If they have power and you don\'t, and your main switch is on, that\'s on your side of the meter and it\'s our job. If nobody has power, ring SA Power Networks first.',
                ],
            },
        ],
        priceFactors: [
        ...
        faqs: [
            {
                ...
                answer: 'It depends where we\'re when you call. We\'re based in Wynn Vale and most of our work is inside the Tea Tree Gully area, so for the suburbs we cover it\'s usually quick. Call 0435 006 420 and we\'ll give you a real time rather than a vague window.',
            },
            {
                question: 'Do you charge more for after-hours callouts?',
                answer: 'Yes, after-hours attendance costs more than a standard weekday visit. We tell you the rate on the phone before we come out, not after we arrive. If the problem can safely wait until morning, we\'ll say so and you can decide.',
            },
            {
                question: 'My safety switch keeps tripping. Is that an emergency?',
                answer: 'If it resets and stays on, it\'s usually a faulty appliance and you can narrow it down yourself by unplugging things one at a time. If it trips again immediately every time you reset it, or if there\'s any smell or heat involved, stop resetting it and call us.',
            },
            {
                question: 'Can you fix it the same visit?',
                answer: 'Most of the time, yes. Common faults get repaired on the spot. If it needs a part we don\'t carry or turns out to be a bigger job like a full switchboard replacement, we make the property safe, restore whatever power we safely can, and book the rest in.',
            },
            {
                question: 'What if the power is out on the whole street?',
                answer: 'That\'s a network fault and it belongs to SA Power Networks on 13 13 66. If your neighbours have power and you don\'t, it\'s on your side of the meter and that\'s when you call us.',
            },
            {
                question: 'Is it safe to just keep resetting the breaker?',
                answer: 'No. The breaker is tripping because it\'s detecting a fault, whether that\'s an overload, a short or current leaking to earth. Resetting it repeatedly forces current through whatever is faulty, and that\'s how a manageable problem turns into a fire. Leave it off and get it looked at.',
            },
        ],
    ...
    },
    {
        ...
        intro:
            'If your switchboard still has rewireable ceramic fuses, has no safety switches, trips regularly, or is so full there\'s nowhere to add a circuit, it\'s due. We replace it with a properly sized board on RCBOs and label it so it makes sense to whoever opens it next.',
        sections: [
            {
                heading: 'Signs Your Switchboard Needs Upgrading',
                body: [
                    'Most of the housing across Modbury, Hope Valley, Holden Hill, St Agnes and Banksia Park went up between the 1960s and the 1980s, and a large share of it\'s still on the original board. These are the things that tell you it\'s time:',
                ],
                bullets: [
            ...
            {
                heading: 'What\'s Involved on the Day',
                body: [
            ...
            },
            {
                ...
                body: [
                    'On houses from the 1960s and 70s, taking the old board off occasionally reveals wiring that isn\'t in good shape. Rubber-insulated cable from that era goes brittle with age and the insulation can break away when it\'s disturbed.',
                    'We tell you that possibility exists before we start rather than after. If it turns up, we show you, explain what it means, and price the options. What we won\'t do is quietly wire a new board onto cable that shouldn\'t be reused.',
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'Usually not. In most houses the board is the urgent part and the existing cabling tests fine. Full rewires are the exception. We test rather than assume, and we\'ll only recommend one if the results actually support it.',
            },
            {
                question: 'Can you add a safety switch without replacing the whole board?',
                answer: 'Sometimes, if there\'s space and the board is otherwise sound. On an old fuse board it\'s often not the better option, because you end up with one shared RCD that trips the whole house on any fault. We\'ll price both and explain the difference so you can decide.',
            },
            {
                question: 'Do I get paperwork afterwards?',
                answer: 'Yes. A Certificate of Compliance for Electrical Work on every job that requires one, plus test results. It\'s your proof the work was done by a licensed electrician and verified, and you want it on file for insurance and for when you sell.',
            },
        ],
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                body: [
                    ...
                    'If you already have three-phase supply, a three-phase charger can go up to around 22 kW where the vehicle supports it. Worth knowing: plenty of EVs only accept single-phase AC charging regardless of what the charger can deliver, so a three-phase charger doesn\'t automatically mean faster charging for your particular car. Check the vehicle before spending the extra.',
                    'Upgrading a single-phase property to three phase purely for charging is rarely worth it. It\'s a significant cost and it usually solves a problem you don\'t have.',
                ],
            },
            {
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'A 7 kW single-phase charger adds roughly 40 km of range per hour, so a normal overnight charge covers well over a typical day of driving. For most households that\'s more than enough and the faster options solve a problem that doesn\'t exist.',
            },
            {
                question: 'Can you install a charger I have already bought?',
                answer: 'Yes, provided it\'s a unit approved for sale and use in Australia. Tell us the model before we quote, because the protection requirements and the circuit sizing depend on what the specific charger needs.',
            },
        ],
    ...
    },
    {
        ...
        intro:
            'A safety switch is the only thing in your house designed specifically to stop a shock from killing someone. It\'s also a mechanical device that can fail silently. We install them, and we test them properly with a calibrated instrument rather than just pressing the button.',
        sections: [
            {
                heading: 'What an RCD Actually Does',
                body: [
                    'An RCD, or safety switch, constantly compares the current flowing out on the active with the current returning on the neutral. If those don\'t match, current is escaping somewhere it shouldn\'t be, which usually means through a damaged appliance, a nicked cable, or a person.',
                    'When it detects that imbalance it disconnects the supply in a fraction of a second. That speed is the whole point. It\'s the difference between a nasty jolt and a fatal one.',
                    'A circuit breaker doesn\'t do this. A breaker protects the wiring from overload and short circuit. It will happily sit there while current flows through a person to earth, because that current is well below what it is watching for. This is the single most common misunderstanding we come across, and it\'s why a board full of breakers and no RCDs isn\'t protected.',
                ],
            },
            {
                heading: 'Why the Test Button isn\'t Enough',
                body: [
                    'The test button on the board proves the mechanism moves. It doesn\'t tell you whether the device trips fast enough to protect someone, and that\'s the number that matters.',
                    ...
                    'You get a written report with the measured trip times for each device, which is the part that matters if you\'re a landlord, run a workplace, or need to demonstrate compliance to an insurer.',
                ],
            },
            {
                ...
                body: [
                    ...
                    'For rental properties, workplaces, medical and disability-care premises, and anywhere with a documented safety obligation, testing is generally on a set schedule and the report is the evidence. The specific interval depends on the type of premises and the relevant requirements, so it\'s worth confirming what applies to your situation rather than assuming.',
                    'One thing worth saying plainly: if your board has no RCDs at all, testing isn\'t the issue. Getting protection fitted is. That\'s normally done as part of a switchboard upgrade, because fitting RCBOs across the board is a better outcome than bolting one shared RCD onto an old fuse board.',
                ],
            },
            {
                ...
                body: [
                    ...
                    'If it trips with nothing plugged in, the fault is in the fixed wiring and it needs testing. If it trips only when it rains, that\'s water getting into an outdoor point or a fitting. Either way it\'s a real fault, and disabling or bypassing the RCD to stop the nuisance is the worst possible response to it.',
                ],
            },
        ],
        priceFactors: [
            'The number of RCDs to be tested and the number of circuits',
            'Whether it\'s a single home visit or a scheduled service across multiple properties',
            ...
            'Any fault finding required if a device fails or a circuit won\'t hold',
        ],
        faqs: [
            {
            ...
            },
            {
                ...
                answer: 'No. The button proves the mechanism moves. It doesn\'t measure whether the device trips fast enough to actually protect someone. An RCD can pass the button test and still fail a proper trip-time test, which is the one that matters.',
            },
            {
                question: 'My safety switch keeps tripping. What\'s causing it?',
            ...
            },
            {
                ...
                answer: 'Yes. You get measured trip times for each device in writing, which is what you need on file as a landlord, a workplace or a medical premises. A verbal "it all tested fine" Isn\'t evidence of anything.',
            },
            {
                question: 'Can safety switches be added to an old fuse board?',
                answer: 'Sometimes, but on an old board it\'s often not the better option. You end up with a single shared RCD that drops the whole house on any fault. Fitting RCBOs as part of a switchboard upgrade protects every circuit individually and is usually the more sensible spend.',
            },
        ],
    ...
    },
    {
        ...
        intro:
            'Smoke alarms have a service life and most people don\'t know theirs has passed it. We install and replace mains-powered interconnected photoelectric alarms, positioned where they will actually detect a fire rather than where they were easiest to screw in.',
        sections: [
            {
                ...
                body: [
                    ...
                    'The fires that kill people in homes are overwhelmingly the smouldering kind, typically starting overnight in furniture, bedding or wiring, producing a lot of smoke well before flame. That\'s why fire services across Australia recommend photoelectric alarms, and it\'s what we install.',
            ...
            },
            {
                ...
                body: [
                    'A standalone alarm in the hallway sounds where the smoke is. If the fire starts in the lounge and you\'re asleep at the far end of the house with the door closed, you may not hear it in time.',
                    'Interconnected alarms all sound together the moment any one of them detects. That\'s the difference between being woken by an alarm in another room and being woken by the alarm above your bed.',
            ...
            },
            {
                ...
                body: [
                    ...
                    'The date is printed on the alarm itself, usually on the back or the side. Take one down and look. If it\'s more than ten years old, it needs replacing regardless of whether it still chirps when tested, because a test confirms the horn and the battery, not the sensor.',
            ...
            },
            {
                ...
                body: [
                    ...
                    'We won\'t guess at your specific obligation on a web page, because the detail matters and it changes. What we\'ll do is look at what you currently have, tell you what it is and how old it is, and point you to the current requirement so you can confirm it. Consumer and Business Services and the SA Metropolitan Fire Service both publish the current position.',
                    'What we can say generally is that a hardwired, interconnected photoelectric alarm arrangement satisfies the more demanding end of the requirements, and it\'s what we would install in our own house.',
                ],
            },
        ],
        priceFactors: [
            'The number of alarms and where they need to go',
            'Whether they\'re hardwired or wireless interconnected',
            'Whether there\'s accessible roof space above each location',
            'Whether it\'s a straight replacement of existing units or new positions requiring cable runs',
            'Whether it\'s being done alongside other work, since roof access is the main labour cost',
        ],
        faqs: [
            {
            ...
            },
            {
                ...
                answer: 'Requirements vary depending on the property and when it was built or sold, but interconnection is strongly worth having regardless. If a fire starts at the other end of the house while you\'re asleep with the door shut, an interconnected system is what wakes you.',
            },
            {
                question: 'Can you do them at the same time as other work?',
                answer: 'Yes, and it\'s the efficient way to do it. If we\'re already in the roof space for a switchboard upgrade or a lighting job, adding hardwired interconnected alarms costs a fraction of what a separate visit would.',
            },
            {
            ...
            },
            {
                ...
                answer: 'A regular single chirp is usually a low battery, even in a mains-powered unit, since those have a backup battery. If replacing the battery doesn\'t stop it, or the unit is more than ten years old, replace the alarm.',
            },
        ],
