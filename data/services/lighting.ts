...
export const lightingServices: Service[] = [
    {
        ...
        sections: [
            ...
            },
            {
                ...
                body: [
                    'You can buy an LED globe that fits an existing halogen can. We don\'t recommend it and we\'ll tell you why.',
                    'The old can is still there, so the insulation clearance requirement is still there, and the transformer feeding it\'s still a halogen transformer that may not run an LED cleanly. That combination is where flickering, buzzing and early failure come from. You have spent money and solved one problem out of three.',
                    'Replacing the complete fitting gives you a modern LED downlight with an integrated driver, rated for insulation contact where appropriate, with a proper beam angle and a consistent colour temperature across the house. It costs more up front and it\'s the version that actually works.',
                ],
            },
            {
                ...
                body: [
                    ...
                    'Better is to light what people actually use. Downlights positioned over benches, in front of wardrobes, along walkways and washing the walls rather than lighting the middle of the room. In a kitchen that usually means a line above the bench edge rather than centred on the ceiling, so you aren\'t standing in your own shadow while chopping.',
            ...
            },
            {
                ...
                body: [
                    'LED dimming is where a lot of jobs come unstuck. Not every LED downlight is dimmable, and of the ones that are, not all of them work with every dimmer. The wrong combination gives you flicker, buzzing, a limited dimming range, or lights that won\'t go below half.',
                    ...
                    'One thing worth knowing: replacing halogens with LEDs on an existing dimmer often won\'t work, because old dimmers were built for a much higher minimum load. That dimmer usually needs replacing along with the lights.',
                ],
            },
        ],
        priceFactors: [
            'The number of downlights and whether they\'re replacements in existing holes or new positions',
            'Whether there\'s accessible roof space above, since a raked ceiling or a second storey is a much bigger job',
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'You can, but we don\'t recommend it. The old can and transformer stay in place, so you keep the insulation clearance requirement and often get flickering or buzzing from the mismatch between an old halogen transformer and an LED lamp. Replacing the complete fitting is the version that actually solves the problem.',
            },
            {
                question: 'How much will I save on power?',
                answer: 'A halogen downlight is around 50 watts and an equivalent LED is roughly 7 to 12. That\'s about an 80 per cent reduction on your lighting load. In a house with thirty downlights running four hours a day, the difference is noticeable on the bill and immediate.',
            },
            {
                question: 'Can insulation go over LED downlights?',
                answer: 'Over fittings specifically rated and marked for insulation contact, yes. Not all LED downlights are, so it depends on the product. It\'s one of the main reasons to change the whole fitting rather than the globe, because it lets the insulation be laid continuously instead of cut around every light.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Usually yes, but it\'s a harder job than a standard single-storey ceiling because there may be no accessible space above. Fitting depth and cable routing become the constraints. We\'ll tell you upfront if a particular position isn\'t practical rather than promising it and discovering otherwise.',
            },
            {
        ...
        sections: [
            ...
            },
            {
                ...
                body: [
                    ...
                    'Visible dots are the most common giveaway. That happens when a low-density strip is mounted too close to the surface it\'s lighting. Higher LED density and a diffuser, or simply more depth in the channel, fixes it.',
                    ...
                    'The third is colour consistency. Cheap strip drifts in colour along its length and between reels, so two runs in the same kitchen end up visibly different. Buying decent product from one batch avoids a problem that can\'t be fixed afterwards.',
            ...
            },
            {
                ...
                body: [
                    'Feature lighting is much cheaper and much better when it\'s designed in before the plaster goes up. Cove details need to be set out with the ceiling. Joinery lighting needs the cabinetmaker to allow for the channel and the cable entry. Stair lighting needs cable in before the treads go on.',
                    'If you\'re renovating, get us in at rough-in stage. We\'ll mark up where the runs and the drivers go, coordinate with your builder and cabinetmaker, and come back for the fit-off once the surfaces are finished.',
                    'Retrofitting into a finished space is possible and we do it regularly, but the options narrow. Under-bench and inside-joinery runs are usually straightforward. A full cove detail in a finished ceiling generally isn\'t.',
                ],
            },
        ],
        priceFactors: [
            'Total run length and the number of separate runs',
            'Whether it\'s going into new work at rough-in stage or being retrofitted into a finished space',
        ...
        faqs: [
            {
                ...
                answer: 'It varies more than most electrical work because the scope varies so much. A single under-bench run in an existing kitchen is a small job. Cove lighting through a whole living area with dimming and multiple circuits isn\'t. The two biggest factors are run length and whether we\'re working into new construction or retrofitting.',
            },
            {
                question: 'Why can I see dots in my LED strip?',
                answer: 'Low LED density, or the strip is mounted too close to the surface it\'s lighting. Higher density strip, a deeper channel, or a diffuser fixes it. It\'s a decision made before installation, not something that can be corrected afterwards.',
            },
            {
                question: 'Can LED strip be dimmed?',
                answer: 'Yes, but the strip, the driver and the dimmer all have to be compatible. It isn\'t something to add later by swapping a switch. Tell us at quote stage if you want dimming so we specify the right combination from the start.',
            },
            {
                question: 'Where does the driver go?',
                answer: 'Somewhere accessible. Drivers fail eventually and if one is buried above a sealed ceiling, replacing it means cutting the ceiling open. We put them in cupboards, above access hatches, or behind removable panels. It\'s the detail that separates a good install from an expensive future problem.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Often, yes. Under-bench, inside-joinery and wardrobe runs are usually straightforward in an existing home. Full cove details in a finished plaster ceiling generally aren\'t worth the disruption. We\'ll tell you which category your idea falls into.',
            },
        ],
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                body: [
                    'Installing a fan onto an existing light point is the cheaper option, and where there\'s already a light in the right spot it\'s often the sensible one. You end up with a fan and light combination on the existing switch.',
                    'The catch is that the existing point is where somebody in 1978 decided the light should go, which is usually the centre of the ceiling. That\'s normally fine for a fan, but not always, particularly in a room that has since been extended or reconfigured.',
                    'A new point costs more because it needs a cable run and roof access, but it puts the fan where the bed actually is and lets us put in a separate wall control. If you\'re doing several rooms it\'s worth deciding room by room rather than applying one answer to the whole house.',
            ...
            },
            {
                ...
                body: [
                    'Most fans now come with a remote, and most remotes end up lost, flat, or in another room. A wall control costs a little more to install and it\'s the version people are still happy with in three years.',
                    'Wall controls also handle the situation where a fan and light are on one existing switch drop, which otherwise means the light and fan can\'t be operated independently without the remote.',
                    'If you want DC-motor fans, and they\'re worth it for the quietness and the lower running cost, note that they\'re almost always remote-controlled by design. Wall-mounted controllers exist for most brands and we\'ll fit one if you want it.',
                ],
            },
            {
                heading: 'Bathroom and Laundry Exhaust',
                body: [
                    'Exhaust fans are the other half of this. A bathroom fan that isn\'t actually clearing moisture is why you get mould on the ceiling and around the window.',
                    'Two things usually cause that. The fan is undersized for the room, or it discharges into the roof space rather than outside. Discharging into the roof space just moves the moisture from a room you can see into a space you can\'t, and over time that causes real damage.',
        ...
        priceFactors: [
            ...
            'Whether there\'s accessible roof space above the position',
        ...
        faqs: [
            {
                ...
                answer: 'Usually yes, and it\'s the cheaper option. The consideration is whether the existing point is actually in the right place, since it\'s normally the centre of the ceiling from when the house was built. We also check the ceiling can carry the fan, which needs a fixing into something structural rather than just plasterboard.',
            },
            {
                question: 'Do I need a wall control or is the remote enough?',
                answer: 'A remote works until it\'s lost or flat, which for most households is a matter of months. A wall control costs a bit more to install and is what people are still happy with years later. For DC fans, which are remote-controlled by design, we can usually fit a wall-mounted controller instead.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Generally yes. They\'re quieter, use significantly less power, and have more speed steps than an AC fan. In a bedroom the noise difference alone is usually what sells people. The trade-off is that they\'re almost always remote-based by design.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Yes, and it\'s usually a quick job since the point and the fixing are already there. If the old fan was mounted straight to plasterboard, which we do see, we\'ll sort out a proper structural fixing while we\'re up there.',
            },
        ],
    ...
    },
    {
        ...
        sections: [
            {
                ...
                body: [
                    ...
                    'The result across most of the housing in Hope Valley, Modbury, St Agnes and Holden Hill is powerboards daisy-chained off powerboards, extension leads run under rugs, and a kitchen where the kettle and the toaster can\'t both be on.',
                    'Adding outlets is one of the cheaper improvements available, and in a single-storey home with accessible roof space it\'s usually straightforward. The thing that matters is doing it properly: running the new outlet back to the board on an appropriate circuit rather than spurring off whatever happens to be nearest, which is the shortcut that causes the overloading problem all over again.',
                ],
            },
            {
                heading: 'When You Need a Dedicated Circuit',
                body: [
                    'Some appliances should have a circuit to themselves rather than sharing with half the house. If yours doesn\'t, that\'s often exactly why something keeps tripping.',
                ],
                bullets: [
                    ...
                    'Dishwashers and washing machines in a kitchen or laundry that\'s already loaded up',
                ],
            },
            {
                heading: 'Outdoor and Weatherproof Outlets',
                body: [
                    'Outdoor power is where we see the most badly done work. An indoor outlet with a plastic cover screwed over it isn\'t a weatherproof outlet, and it\'s a genuine hazard once water gets in.',
                    ...
                    'On the bigger blocks around Tea Tree Gully, Vista and Banksia Park, the more common request is proper power to a shed at the back of the block. That\'s a submain rather than an outlet: a correctly sized cable for the distance and the load, with its own small board and protection at the shed end. If your shed lights currently dim when you start a tool, the existing run is undersized and that\'s the fix.',
                ],
            },
            {
                ...
                body: [
                    ...
                    'Smart switches and dimmers we\'ll install, with one honest caveat: they depend on a hub, an app and a wifi network, and when any of those change or stop being supported, the switch on your wall becomes someone else\'s problem. For most homes we would rather put in good quality conventional switching and put the smart layer where it genuinely adds something.',
                    'If you\'re running a home office, it\'s worth thinking about circuit separation as well as outlet count. Having the office on its own circuit means a tripping appliance in the kitchen doesn\'t take your work machine down with it.',
                ],
            },
        ],
        priceFactors: [
            'The number of outlets and how far each is from an existing circuit',
            'Whether there\'s accessible roof space above, or whether it\'s a two-storey or slab-on-ground situation',
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'Because they\'re on the same circuit and that circuit is doing what it was designed to do. In a 1970s kitchen the whole room is often on one circuit that was never intended for modern appliance loads. The fix is either splitting the kitchen across additional circuits or adding a dedicated one for the high-draw appliances.',
            },
            {
                question: 'Can I add outlets to an existing circuit?',
                answer: 'Often yes, provided the circuit has the capacity and the arrangement complies. Where it doesn\'t, the honest answer is a new circuit rather than adding more load to something already at its limit. We check before we quote so you know which you\'re getting.',
            },
            {
                question: 'Can you install a weatherproof outlet outside?',
                answer: 'Yes, using a properly IP-rated enclosure and outdoor-suitable cable with RCD protection. An indoor point with a cover over it isn\'t the same thing and is a real hazard once water finds its way in.',
            },
            {
                question: 'My shed power is unreliable. What\'s wrong?',
            ...
            },
            {
                ...
                answer: 'Yes to both. USB-integrated outlets are genuinely useful and cost little extra when done alongside other work. On smart switches we\'ll install what you want, but we\'ll also tell you honestly that they depend on an app and a hub that may not be supported in five years.',
            },
        ],
