...
/** Appliance, renovation, trade and compliance work. */
export const projectServices: Service[] = [
    {
        slug: 'oven-cooktop-installation-adelaide',
        ...
        sections: [
            ...
            },
            {
                ...
                bullets: [
                    ...
                    'Induction, ceramic and solid-element cooktops, including the dedicated circuits they need',
                    'Freestanding electric cookers',
                    'Rangehoods, including ducted units and the outlets behind them',
                    'Gas-to-electric conversions, where the electrical work is the whole job',
                    'Dishwashers, microwaves and other built-in appliances that need a point in the right place',
                    'Isolation switches, positioned where you can actually reach them without pulling the appliance out',
                ],
            },
            {
        ...
        priceFactors: [
            'Whether the existing supply is adequate or a new dedicated circuit is needed',
        ...
        faqs: [
            {
                ...
                answer: 'Almost always, yes. A typical four-zone induction cooktop draws well over 30 amps at full output and is hardwired. The circuit that fed your old oven was usually not sized to carry that as well, so a dedicated circuit from the switchboard is normally required.',
            },
            {
            ...
            },
            {
                ...
                answer: 'A straight like-for-like replacement into an existing suitable point is a small job. It gets more involved when a new circuit is needed, when the run from the switchboard is long, or when the board has no spare capacity. Tell us the appliance model and we can be specific.',
            },
            {
                question: 'When should I book the electrician in a kitchen renovation?',
                answer: 'At planning stage, then on site for rough-in once the old kitchen is out and before plaster and cabinetry, then again for fit-off after the benchtop goes in. Being called after the cabinetry is installed is how outlets end up behind fixed panels.',
            },
            {
    ...
    {
        slug: 'renovation-electrician-adelaide',
        ...
        priceFactors: [
            'The scope: a single bathroom is very different to a whole-home renovation',
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'Yes, and we build the job around it. Rough-in before plaster, fit-off after cabinetry, with us off site in between. We would rather coordinate properly than be the trade everyone is waiting on.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Bathrooms have zone requirements that govern what fittings can be installed where in relation to the bath and shower, plus RCD requirements on the new circuits. Heat lamps, exhaust fans and lighting all have to sit within those rules, so the positions need to be planned rather than chosen on the day.',
            },
        ],
        related: ['electrician-for-builders-adelaide', 'oven-cooktop-installation-adelaide', 'feature-lighting-led-strip-adelaide'],
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                body: [
                    'We work with builders, renovators, property developers and shopfitters across Adelaide\'s north-east, on jobs from a single-room extension up to full renovations and small commercial fitouts.',
                ],
                bullets: [
                    'New build residential rough-in and fit-off',
                    'Extensions and additions, including tying new work into an existing installation',
                    'Full home renovations, including the switchboard upgrade that usually comes with them',
                    'Kitchen and bathroom fitouts, coordinated with cabinetmakers and tilers',
                    'Small commercial and retail fitouts, including lighting, power, distribution boards and exit and emergency lighting',
                    'Medical, dental and allied health consulting rooms, which carry their own requirements',
                    'Temporary builder\'s supply and site power',
                    'Defect rectification and handover snagging',
                ],
            },
            {
            ...
            {
                heading: 'Working Alongside Other Trades',
                body: [
                    'The rough-in stage is where most trade friction happens, because everyone needs the same wall cavity at the same time.',
                    'We coordinate with the plumber on wall penetrations and service routes rather than each drilling through the other\'s work. We set out to the cabinetmaker\'s drawings so appliance points and joinery lighting end up where the cabinetry actually is. We talk to the HVAC installer about duct routes before running cable through the space they need.',
                    'None of this is complicated. It just requires being willing to have a two-minute conversation on site rather than working in isolation and sorting it out afterwards with a hole saw.',
                ],
            },
        ],
        priceFactors: [
            'Point count and circuit count from the plans',
            'Single or double storey, and slab versus suspended floor construction',
            'The specification level of fittings, lighting and switching',
            'Whether the switchboard is new or being upgraded from existing',
            'Site access, storey height and how much of the work is retrofit into existing structure',
            'Program requirements, including whether staged attendance is needed',
        ],
        faqs: [
            {
                question: 'Do you work as a subcontractor for builders?',
                answer: 'Yes, regularly. New builds, extensions, renovations and small commercial fitouts across Adelaide\'s north-east. We quote from plans, we turn up when scheduled, and we get the compliance paperwork back without being chased.',
            },
            {
            ...
            },
            {
                ...
                answer: 'Yes, at the small to mid scale. Lighting, power, distribution boards, exit and emergency lighting, and data and comms rough-in. We also do medical, dental and allied health consulting rooms, which have specific requirements.',
            },
            {
    ...
    },
    {
        ...
        sections: [
            ...
            {
                heading: 'Who This Is Genuinely Worth It For',
                body: [
                    'Thermal imaging earns its keep where an electrical failure has real consequences, or where the installation carries serious load.',
                ],
                bullets: [
                    ...
                    'Older switchboards that have never been inspected internally',
                    'Any board that has had a history of tripping, heat marks or a burning smell',
                    'Installations that have had significant load added, such as solar, EV charging or new plant',
                ],
            },
            {
                heading: 'How It Pairs With RCD Testing',
                body: [
                    'These two checks cover completely different failure modes and are best done together in the same visit.',
                    'RCD testing confirms that if current leaks to earth, the supply disconnects fast enough to protect a person. It says nothing at all about whether a connection in your board is cooking itself.',
                    'Thermal imaging finds the overheating connection. It says nothing about whether your shock protection works.',
                    'Doing both at once means one visit, one report covering both, and a genuine picture of the installation\'s condition rather than half of one.',
                ],
            },
        ],
        priceFactors: [
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'A report with the thermal image, a matching standard photo of the same location, the load conditions at the time, and a plain-English assessment of what each finding means and how urgent it is. Not a pile of images with no interpretation.',
            },
            {
        ...
        sections: [
            {
                ...
                body: [
                    'Test and tag covers electrical equipment connected by a flexible cord and plug, which in most workplaces is a longer list than people expect once they start counting.',
                ],
                bullets: [
                    'Power tools, battery chargers and workshop equipment',
                    'Extension leads and portable power boards, which fail more often than anything else',
                    'Computers, monitors, printers and IT equipment',
                    'Kitchen and break room appliances, including kettles, microwaves and fridges',
                    'Cleaning equipment, vacuums and floor machines',
                    'Portable lighting and site lighting',
                    'Medical and clinical equipment with a plug and lead',
                    'Portable RCDs and safety switch adaptors, which are tested differently to standard equipment',
                ],
            },
            {
        ...
        faqs: [
            {
                ...
                answer: 'It depends on the environment and the equipment type, with harsher environments needing shorter intervals. A construction site is at one end, a quiet office at the other. We look at what your workplace actually does, set a schedule to suit, and remind you when it falls due.',
            },
            {
                question: 'What do I get afterwards?',
                answer: 'A tag on each item showing the test date, the retest date and who tested it, plus a register listing every item, its location, its result and its next due date. The register is what you produce when an auditor or an insurer asks.',
            },
            {
                question: 'Is test and tag legally required?',
                answer: 'Workplaces have a general duty to ensure electrical equipment is safe, and testing and tagging is the standard way of demonstrating that. Whether a specific interval applies depends on your industry and environment. In practice, principal contractors and clients frequently require it regardless.',
            },
            {
