...
export const faqGroups: FaqGroup[] = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                answer: 'We service all of Adelaide. We are based in Wynn Vale, so the north-east is where we work most often and where we can usually get to you fastest, but we take on work right across the metro area and into regional South Australia when it makes sense. If you are not sure, just call and ask.',
            },
            {
