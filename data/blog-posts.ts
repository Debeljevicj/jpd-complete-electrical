...
const legacyPosts: BlogPost[] = [
    ...
    },
    {
        ...
        content: `
            <h3>Why This Matters to You</h3>
            <p>Most electrical incidents in homes aren't dramatic. They're a cord that has been quietly overheating under a rug, a safety switch that stopped working three years ago and nobody noticed, or a power board carrying twice what it was designed for. None of these announce themselves. They sit there until something gives.</p>
            <p>The good news is that a decent share of it's checkable in about twenty minutes, without tools, by anyone living in the house. What follows is what actually matters, split into what you can do yourself and what needs a licensed electrician. Adelaide summers put real load on a house, so if you're going to run through this, the start of the warmer months is a sensible time.</p>

            <h3>1. Test Your Safety Switches, and Understand What the Test Proves</h3>
            <p>A safety switch (RCD) is designed to cut power within about 30 milliseconds if current starts leaking somewhere it shouldn't, through a damaged appliance, a nicked cable, or a person. It's the single biggest defence against electric shock in a modern home.</p>
            <p>Press the "Test" button on each one every three months. It should trip instantly. If it doesn't, stop using that circuit and call an electrician.</p>
            <p>Here's the part most people miss: the test button only confirms the mechanism moves. It doesn't confirm the device trips fast enough, or at the right leakage current, to actually protect someone. That needs a calibrated tester, and it's the difference between "the button works" and "this will save someone". If your RCDs have never had a proper instrument test, that's worth booking. Our guide to <a href="/blog/rcd-testing-thermal-imaging-adelaide/">RCD testing and thermal imaging</a> covers what a real test involves, and <a href="/rcd-testing-safety-switches-adelaide/">RCD testing and safety switches</a> explains the service itself.</p>
            <p>One more thing worth checking: a lot of older Adelaide homes have RCD protection on the power circuits but not the lighting circuits. If yours is like that, you're only half covered.</p>
            ...
            <p>If you're permanently short of outlets in a room, that's the actual problem, and the fix is <a href="/powerpoint-installation-adelaide/">additional powerpoints</a> rather than more boards. It's safer, it's tidier, and in most rooms it's a straightforward job.</p>
            ...
            <p>Just as important is where cords run. Never under a rug or carpet, where heat can't escape and foot traffic works the insulation loose. Never pinched behind furniture pushed hard against a wall. Never through a doorway that closes on them.</p>
            ...
            <p>Bathrooms, kitchens, laundries and anywhere outdoors carry more risk because water lowers the resistance between you and earth. Dry your hands before touching switches. Keep appliances well clear of sinks and baths. Don't use a portable heater in a bathroom.</p>
            <p>Outside, check that outdoor outlets have intact weatherproof covers that actually close, and that any lead running to a shed or pergola is rated for outdoor use rather than draped across the lawn. Garden power in older Adelaide homes is frequently an afterthought that has been extended over the years, and it's a common place to find work that was never done by a licensed electrician.</p>

            <h3>5. Know the Age of Your Switchboard</h3>
            <p>If your board still has ceramic fuses, the ones with the removable carriers and fuse wire, it belongs to an era before safety switches existed. It offers no shock protection at all, only rudimentary overload protection, and it can't be extended to run modern loads.</p>
            <p>A lot of the housing stock through the north-eastern suburbs sits in exactly this bracket. If your board looks like it came with the house and the house is from the sixties or seventies, it's worth having assessed. The <a href="/blog/signs-you-need-switchboard-upgrade/">warning signs that a switchboard needs upgrading</a> covers this in more detail, and <a href="/switchboard-upgrade-adelaide/">switchboard upgrades</a> explains what the work involves.</p>
            ...
            <p>None of those are emergencies on their own, and all of them are worth acting on, because they're the early version of a problem that gets more expensive and more dangerous the longer it runs.</p>

            <h3>When to Stop and Call Someone</h3>
            <p>Turn off the main switch and call an electrician straight away if you smell burning plastic, see scorch or brown marks around an outlet or the switchboard, get any kind of tingle from an appliance or a tap, or have a breaker that trips immediately every time you reset it. That last one means there's a fault on the circuit right now, and resetting it repeatedly isn't a fix.</p>
            <p>If it's after hours and it won't wait, that's what an <a href="/emergency-electrician-adelaide/">emergency electrician</a> is for.</p>
    ...
    },
    {
        ...
        content: `
            <h3>Why This Matters to You</h3>
            <p>If your house still has halogen downlights, you're paying to heat your ceiling. A halogen converts most of the energy it draws into heat rather than light, and in a house with twenty of them the running cost adds up to real money every year.</p>
            ...
            <p>A standard halogen downlight draws around 50 watts. An equivalent LED does the same job on roughly 8 watts. That's about 42 watts saved per fitting.</p>
            ...
            <p>That's 840 watts saved when they're all running, about 3.4 kilowatt hours a day, and roughly 1,200 kilowatt hours across a year. At 45 cents, somewhere near 550 dollars a year.</p>
            ...
            <p>Halogen globes typically give 1,000 to 2,000 hours. A decent LED fitting is rated for 25,000 hours or more. On the four hours a day above, that's a globe change every year or so versus something that should outlast the next fifteen.</p>
            <p>The practical benefit isn't really the cost of globes. It's never having to get the ladder out, work out which of the three fittings above the stairwell has gone this time, and find that the replacement is a slightly different colour to the rest.</p>
            ...
            <p>It's also why you sometimes find a neat square of missing insulation around each downlight in an older house, which is doing exactly what it should for fire safety while quietly undermining the thermal performance you paid for.</p>
            <p>LEDs run cool enough that appropriately rated fittings can be covered by insulation, so you get the full benefit of the insulation and lose the hot spots. In an Adelaide summer that's worth something beyond the lighting bill.</p>

            <h3>Light Quality, and Choosing a Colour Temperature</h3>
            <p>Modern LEDs come in a range of colour temperatures, and this is the choice people most often get wrong, because it's made on a shelf under fluorescent lighting rather than in the room.</p>
            ...
            <p>Mixing temperatures across an open plan area is the other common mistake. If the kitchen and living room see each other, they should match. Many current fittings are switchable across all three, which takes the risk out of the decision, and it's worth asking for those.</p>
            <p>Colour rendering matters too, particularly in kitchens and bathrooms. A poor LED makes food and skin tones look wrong in a way that's hard to name but easy to notice.</p>

            <h3>What a Proper Upgrade Involves</h3>
            <p>Swapping a halogen for an LED isn't always just changing the globe. Depending on what you have, the job may involve removing old transformers, which continue drawing power and are a common failure point, replacing the whole fitting rather than the lamp, and checking that the existing cabling and the way the fittings were installed is sound.</p>
            ...
            <p>If you're changing the number or position of fittings rather than swapping like for like, that's a lighting design question as much as an electrical one, and it's worth getting right while the ceiling is open. Our <a href="/downlight-installation-adelaide/">downlight installation</a> page covers the layout side, and <a href="/feature-lighting-led-strip-adelaide/">feature lighting and LED strip</a> covers the work that goes beyond general lighting.</p>

            <h3>Where the Cheap Version Goes Wrong</h3>
            <p>The failure modes with budget LED fittings are predictable. Flicker, which some people see and some don't, and which is genuinely unpleasant if you're one of the people who does. Buzzing on dimmers, because the dimmer was designed for a resistive halogen load and an LED isn't one. Colour drift, where fittings that matched on day one no longer match after two years. And early driver failure, where the LED chip is fine but the electronics behind it aren't, at which point you're replacing the fitting anyway.</p>
            <p>If you're dimming, the dimmer and the fitting need to be a compatible pair. That's the single most common reason a new LED install disappoints, and it's entirely avoidable by choosing them together.</p>
    ...
    },
    {
        ...
        excerpt: `The warning signs worth acting on, what a switchboard upgrade actually involves, and what it won't fix.`,
        date: '2023-11-20',
        updated: '2026-09-01',
        author: 'Justin',
        category: 'Maintenance',
        ...
        gallery: [
            {
                ...
                caption:
                    'Ceramic fuses. This board predates safety switches entirely, so there\'s no shock protection on anything it feeds.',
            },
            {
                ...
                caption:
                    'One safety switch covering the whole house. It works, but any fault anywhere takes the entire place out, and it\'s a long way short of what a board would be built with today.',
            },
            {
            ...
            },
            {
                ...
                caption:
                    'A main switch cooked by a loose connection. This board wasn\'t especially old. Heat damage is about workmanship and load, not just age.',
            },
        ],
        content: `
            <h3>Why This Matters to You</h3>
            <p>Your switchboard is where every circuit in the house terminates and where all the protection lives. When it's old, the failure is rarely sudden. It's a slow drift where the board gets less able to handle what the house now asks of it, while the protection it offers falls further behind what's expected.</p>
            <p>Modern houses draw far more than the ones these boards were designed for. Ducted air conditioning, induction cooktops, EV chargers, heat pump hot water, a home office running all day. A board specified in 1972 wasn't built with any of that in mind.</p>
            <p>Here's what to look for, in rough order of how urgently it needs attention.</p>

            <h3>1. Burning Smell or Scorch Marks</h3>
            <p>Taking this out of order because it's the one that can't wait. If you smell hot or burning plastic near the board, or see brown or black marks around the board or any outlet, turn off the main switch and call an electrician immediately.</p>
            <p>That smell is insulation or plastic getting hot enough to break down, which means a connection is arcing or badly overloaded. It doesn't resolve itself. Left alone it progresses to a fire, and it can do so quickly.</p>
            <p>Worth knowing: a connection can run hot for months before it ever produces a smell or a mark. That's precisely what <a href="/thermal-imaging-adelaide/">thermal imaging</a> is for, and it's covered in more detail in our guide to <a href="/blog/rcd-testing-thermal-imaging-adelaide/">RCD testing and thermal imaging</a>. It's the only practical way to catch this stage early.</p>

            <h3>2. No Safety Switches, or Only Partial Coverage</h3>
            <p>If your board has no RCDs at all, you have no shock protection, and that's the strongest single argument for upgrading.</p>
            <p>More common, and easier to miss, is partial coverage. Plenty of Adelaide homes had RCDs added to the power circuits at some point and never to the lighting circuits. That leaves the lighting, and often anything hard wired like exhaust fans, with no shock protection at all. People in that situation generally believe they're covered, because there's an RCD on the board.</p>
            <p>If you aren't sure which of your circuits are protected, that's worth establishing. It's a quick thing to check and the answer is frequently not what the owner expected.</p>
            ...
            <p>If the same breaker goes every time the kettle and the toaster run together, that circuit is at capacity, which normally means too much has been added to it over the years. If a breaker trips immediately every time you reset it, there's a live fault on that circuit right now, and it needs looking at rather than resetting.</p>
            <p>What matters is whether it's getting more frequent. A circuit that tripped twice last year and twice last month is telling you something is deteriorating.</p>

            <h3>5. Lights That Flicker or Dim Under Load</h3>
            <p>Lights dipping when the air conditioner or the oven kicks in points to a loose connection or a circuit working harder than it should. Loose connections are the ones to take seriously, because a loose connection is a hot connection, and that's the same path that ends in the scorch marks above.</p>
            <p>If the flickering is house wide rather than one room, it's more likely to be at the board or the incoming supply, and that's worth investigating properly.</p>

            <h3>6. No Room Left on the Board</h3>
            <p>This one isn't a safety issue on its own, it's a planning one. If the board is physically full, every future addition becomes awkward and expensive. Adding an <a href="/ev-charger-installation-adelaide/">EV charger</a>, a new air conditioner, or a decent workshop circuit all need a spare way and adequate capacity.</p>
            <p>If you're considering any of those in the next few years, doing the board first is usually cheaper than doing it twice.</p>
            <p>There's more on this in <a href="/blog/switchboard-full-no-spare-ways-adelaide/">what a full switchboard actually blocks</a>, including how to check before you commit to the equipment.</p>

            <h3>7. Asbestos Backing Board</h3>
            <p>Switchboards from roughly the fifties through the seventies were often mounted on asbestos backing sheet. Undisturbed and in good condition it isn't an immediate hazard, but it does constrain what can be done to the board, and it needs handling correctly during any upgrade rather than being discovered halfway through.</p>
            <p>If your board is that vintage, mention it when you get a quote so it's priced properly from the start rather than becoming a variation on the day.</p>
            ...
            <p><strong>Ceramic fuses.</strong> The first board is the straightforward case. Rewireable fuses, no safety switches, nothing that could be described as modern protection. There's no diagnosis needed here: a board like this is at the end of its life and the only question is timing.</p>
            <p><strong>One safety switch doing everything.</strong> The second is the one people get wrong, because there's an RCD on the board and the owner reasonably assumes they're covered. They are, in the narrow sense. But a single device protecting every circuit means one fault anywhere puts the whole house in the dark, and it's nothing like the per-circuit protection a board would be built with now.</p>
            <p><strong>Labels that are guesses.</strong> The third board is labelled by hand, and a couple of the labels have question marks. Somebody wasn't certain what those circuits fed and wrote down their best guess. That isn't a safety fault on its own. It does mean nobody can safely isolate part of the house without testing first, and it's a reliable sign the board has been added to over the years without anyone stepping back.</p>
            <p><strong>Heat damage.</strong> The fourth is the one worth dwelling on, because that board wasn't especially old. The main switch is discoloured and heat damaged from a loose connection left behind by an earlier solar install. Age had nothing to do with it. A poor termination on a newer board will cook itself just as happily as an old one, which is why "my board is only fifteen years old" Isn't the reassurance people take it for.</p>
            ...
            <p>Expect the power to be off for a chunk of the day. Expect the electrician to find at least one thing behind the old board that nobody knew about, because on boards of this age that's closer to the rule than the exception. A good quote states what's included, what's excluded, and what happens if something turns up once the old board is off the wall. Ours does, and you hear about anything unexpected before the work continues rather than on the invoice.</p>
            <p>The <a href="/switchboard-upgrade-adelaide/">switchboard upgrade</a> page covers the process and what drives the price.</p>

            <h3>What It won't Fix</h3>
            <p>Being straight about this: a new board doesn't rewire the house. If the cabling in the walls is old rubber or fabric insulated, or previous work was done poorly, the new board will protect those circuits far better than the old one did, but the cabling itself is unchanged.</p>
